...
<script>
	$(document).ready(function() {
		...
		$("#total_payment").click(function(event) {
		...
		<div class="container">
			...
			<div class="row" style="border: solid silver 1px; margin-top: 5px">
				...
				<div class="row">
					...
					<div class="col-xs-offset-1 col-xs-3 col-xs-offset-1"
						...
						<h4 ><span style="color: green" id="total">${total}</span>원</h4>
					</div>
				</div>
				<hr>
				<div class="row">
					...
					<div class="col-xs-4" style="background-color: #ffffc2">
						...
						<div class="col-xs-offset-1">
							<input type="text" id="final_pay"
								...
								name="final_pay" value="${total}" readonly="readonly" />원
						</div>
						<hr>
						<div class="col-xs-6">상품 금액</div>
						<div class="col-xs-offset-1 col-xs-5">${total}원</div>
			...
			<div class="row" style="border: solid silver 1px;">
				<div class="col-xs-offset-3 col-xs-3" style="text-align: right;">
					<button id="total_payment" class="col-xs-10 btn btn-success">
						<h4>결제</h4>
					</button>
				</div>
				<div class="col-xs-3">
